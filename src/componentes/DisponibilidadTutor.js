...
class DisponibilidadTutor extends Component {
    ...
    setSchedule(e){
        ...
        axios.post(`${baseURL}/users/${store.getState().id}/tutor/schedules` , {ids}).then((response) => {
    ...
    getSchedule ( e ){
        ...
        console.log(`${baseURL}/users/${store.getState().id}/tutor/schedules`)
        axios.defaults.headers.common['Authorization'] =  localStorage.getItem('jwtToken');
